...
import { TrendingUp, Users, Flag, ArrowUpRight } from 'lucide-react'; // Necesitarás lucide-react
import StatCounter from '../components/StatCounter';

// Componente de decoración para las esquinas (toque técnico)
const Corner = ({ className }) => (
  <div className={`absolute w-3 h-3 border-negro-illimani ${className}`} />
);
...
const StatsSection = forwardRef((props, ref) => {
  ...
  return (
    <section ref={ref} className="relative py-20 md:py-32 bg-arcilla border-b-4 border-negro-illimani overflow-hidden">
      ...
      {/* --- FONDO --- */}
      {/* Ruido */}
      <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-25 mix-blend-multiply pointer-events-none z-0" />
      
      {/* Patrón Topográfico (SVG Decorativo) */}
          ...
          {statsData.map((stat, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Decoraciones de Esquina (aparecen en hover) */}
