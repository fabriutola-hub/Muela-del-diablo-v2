    ...
    <section ref={ref} className="py-32 bg-arena border-b-3 border-negro-illimani overflow-hidden">
      <div className="max-w-[1800px] mx-auto px-6 md:px-12">
        ...
        <div className="relative w-full overflow-hidden py-4">
          {/* Sombras laterales para suavizar el corte (opcional en brutalismo, pero útil) */}
          ...
          <motion.div
            ...
            // Ajusta el valor final (-2000) según el ancho real de tus tarjetas x cantidad
            animate={
              shouldReduceMotion
                ? { x: 0 } 
                : { x: [0, -2000] }
            ...
            transition={{
              x: {
                duration: 60, // Velocidad del scroll
                repeat: Infinity,
                ease: "linear"
              }
            }}
